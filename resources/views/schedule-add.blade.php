    ...
    <style>
        ...
        * {
        ...
        .btn-cancel {
            ...
            color: #FFFFFF;
            box-shadow: 0 10px 25px rgba(76, 11, 11, 0.18);
        }

        .btn-cancel:hover {
            transform: translateY(-1px);
            box-shadow: 0 14px 30px rgba(76, 11, 11, 0.25);
        }
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            <header class="top-header">
                <div>
                    <h1 class="top-header-title">Add Shift Pegawai</h1>
            ...
            <section class="content-wrapper">
                <div class="form-header">
                    <div>
                        <h2 class="form-title">Add Shift Pegawai</h2>
                        <p class="form-subtitle">Tambahkan informasi shift baru sesuai kebutuhan operasional.</p>
                    </div>
                </div>
                ...
                <form action="{{ route('schedule.store') }}" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="code" name="code" placeholder="SHIFT-1" value="{{ old('code') }}">
                            @error('code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Shift Pagi" value="{{ old('name') }}">
                            @error('name')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="description" name="description" placeholder="Tambahkan catatan shift jika diperlukan">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('schedule.index') }}" class="btn btn-cancel">Cancel</a>
