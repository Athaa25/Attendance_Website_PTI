...
<head>
    ...
    <title>Add Departemen &amp; Jabatan</title>
    <style>
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            <header class="top-header">
                <div>
                    <h1 class="top-header-title">Add Departemen &amp; Jabatan</h1>
            ...
            <section class="content-wrapper">
                <div class="form-header">
                    <h2>Add Departemen &amp; Jabatan</h2>
                    <p style="margin: 0; color: var(--text-muted);">Tambahkan departemen dan jabatan baru untuk struktur organisasi Anda.</p>
                </div>
                ...
                <form action="{{ route('departments.store') }}" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="department_name" name="department_name" value="{{ old('department_name') }}" placeholder="Masukkan nama departemen" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="position_name" name="position_name" value="{{ old('position_name') }}" placeholder="Masukkan nama jabatan" required>
                            @error('position_name')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
